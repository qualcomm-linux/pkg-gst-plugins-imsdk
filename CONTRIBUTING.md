# Contributing to pkg-gst-plugins-imsdk
...
1. [Fork](https://github.com/qualcomm-linux/pkg-gst-plugins-imsdk/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/pkg-gst-plugins-imsdk.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-gst-plugins-imsdk.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-gst-plugins-imsdk/pulls) from your branch to `main`.
